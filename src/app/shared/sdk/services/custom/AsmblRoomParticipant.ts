...
/**
 * Api services for the `AsmblRoomParticipant` model.
 */
@Injectable()
export class AsmblRoomParticipantApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id AsmblRoomParticipant id
   *
   ...
   * This usually means the response is a `AsmblRoomParticipant` object.)
   * </em>
   */
  public getRoom(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AsmblRoomParticipants/:id/Room";
